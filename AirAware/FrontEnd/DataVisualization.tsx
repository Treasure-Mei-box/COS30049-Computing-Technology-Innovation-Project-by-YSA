        ...
        {activeTab === "annual" && (
          <>
            ...
            <section className="bg-transparent rounded-2xl shadow p-6 mb-10 mt-2 dark:bg-gray-800">
              <h3 className="text-base font-semibold mb-2 dark:text-gray-100">Weather Metrics Overview</h3>
                    ...
                    >
                      ...
                      <div className="flex w-full justify-between items-center mb-2">
                        ...
                        <div className="flex w-full h-8 rounded overflow-hidden mb-3">
                          ...
                          {moderateDays > 0 && (
                            <div
                              className="bg-yellow-400 flex items-center justify-center text-gray-900 dark:text-gray-900 font-semibold text-sm"
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 mb-6 w-full">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="w-full">
                ...
                focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-500 w-full"
                  >
                    {regionCountryPairs.map(pair => (
                      <option key={pair} value={pair}>{pair}</option>
                    ))}
              ...
              <div className="w-full">
                ...
                <div className="flex flex-col sm:flex-row gap-3 w-full">
                  <select
                    ...
                    className="flex-1 w-full rounded-xl bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600
        text-gray-800 dark:text-gray-200 px-4 py-3 text-sm font-medium
